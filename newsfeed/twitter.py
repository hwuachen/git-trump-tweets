...
class Twitter:
    ...
    def __init__(self):
        ...
        self.twitter_auth = OAuthHandler(settings.CONSUMER_KEY, settings.CONSUMER_SECRET)
                                        
        self.twitter_auth.set_access_token(settings.ACCESS_TOKEN, settings.ACCESS_SECRET)
...
class TwitterListener(StreamListener):
    ...
    def __init__(self, callback):       
        # self.logs = Logs(name="twitter-listener")
